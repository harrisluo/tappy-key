...
// DOM bindings
const yubi = document.querySelector("#yubi");
    ...
    const move = () => {
        ...
        pipes.forEach((pipe_element) => {
            ...
            if (pipe_rect.right <= 0) {
                ...
                if (yubi_rect.left + HORIZONTAL_HITBOX_LEEWAY < pipe_rect.right &&
                    ...
                    if (pipe_rect.right < yubi_rect.left &&
                        pipe_rect.right +
                    ...
                    pipe_element.style.left = `${pipe_rect.left - SCROLL_SPEED}px`;
                }
            }
        });
        ++dist_to_last_pipe;
